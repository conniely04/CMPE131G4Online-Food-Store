...
const CategoryItems = ({ selectedCategory }) => {
  ...
  const itemsData = {
    ...
    "Sea Food": [
      { id: 1, name: "Tuna", image: "tuna.png" },
      { id: 2, name: "Cod", image: "protein2.jpeg" },
      { id: 3, name: "Shrimp", image: "protein2.png" },
      { id: 4, name: "Salmon", image: "protein2.png" },
      { id: 5, name: "Tilapia", image: "protein2.png" },
      { id: 6, name: "Mussels", image: "protein2.png" },
      { id: 7, name: "Crab", image: "protein2.png" },
      { id: 8, name: "Lobster", image: "protein2.png" },
      { id: 9, name: "Scallops", image: "protein2.png" },
      { id: 10, name: "Swordfish", image: "protein2.png" },
      // Add more items for 'Drinks'
    ],
  };
